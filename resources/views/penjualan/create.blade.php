...
<div class="container py-4">
    ...
    <form method="post" action="{{ route('penjualan.store') }}" class="card p-3">
        @csrf
        <div id="items-wrapper">
            <div class="row g-2 align-items-end item-row mb-2">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" step="0.01" name="item_harga_jual[]" class="form-control" placeholder="Auto dari master">
                </div>
